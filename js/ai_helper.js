async function askAI() {
    ...
    const prompt = `你是一個英文母語教師，現在想提升一位高中生的英文。有一個單字 [${vocab}]，它的詞性 [${pos}] 與它其中一個意思 [${meaning}]，請產生一個 [1.語法正確 2.自然 3.符合該意思的用法 4.不使用複雜文法 5.簡短 6.多用不改變單字原意的片語 7.原單字完整出現在句子裡 8.使用英文] 的英語例句。請只輸出句子本身並不要在前後加上括號。謝謝。`
